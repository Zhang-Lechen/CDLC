...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        label_2->setGeometry(QRect(20, 110, 111, 41));
        addpushButton = new QPushButton(Form);
        addpushButton->setObjectName(QStringLiteral("addpushButton"));
        addpushButton->setGeometry(QRect(370, 50, 111, 31));
        label_7 = new QLabel(Form);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(110, 60, 21, 16));
        QFont font;
        ...
        label_8->setGeometry(QRect(230, 60, 21, 16));
        ...
        lineEdit_4->setGeometry(QRect(30, 160, 411, 41));
        label_3 = new QLabel(Form);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(360, 100, 131, 31));
        QFont font1;
    ...
    void retranslateUi(QWidget *Form)
    {
        ...
        addpushButton->setText(QApplication::translate("Form", "\345\212\240\346\263\225\350\256\241\347\256\227", 0));
        label_7->setText(QApplication::translate("Form", "+", 0));
        label_8->setText(QApplication::translate("Form", "=", 0));
        lineEdit->setText(QString());
        lineEdit_2->setText(QString());
        label_3->setText(QApplication::translate("Form", "Sensor", 0));
    } // retranslateUi
