...
/***********************************************
*TODO:PolarUnit4�ӿڵ������ͺ������ڸú����е��ýӿڵķ�����
*�÷����ڷ�������ע��
***********************************************/
void ECOM::Components::Navidisplay::PolarUnit4_send_request()
{
	...
	***********************************************/
	//====================添加的业务逻辑=====================//
	double num1 = this->uiForm->lineEdit->text().toDouble();
	double num2 = this->uiForm->lineEdit_2->text().toDouble();
	double ret = this->getRequireInterfacePolarUnit4()->minus(num1,num2);
	this->uiForm->lineEdit_3->setText(QString::number(ret,'f',2));
	//====================添加的业务逻辑end=====================//
...
//====================添加的业务逻辑=====================//
void ECOM::Components::Navidisplay::on_addpushButton_clicked()
{
	boost::thread *pThread;
	pThread = new boost::thread(boost::bind(&ECOM::Components::Navidisplay::PolarUnit4_send_request, this));
}
//====================添加的业务逻辑end=====================//
